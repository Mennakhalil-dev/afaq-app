...
export default async function SecurityPage({ params: { locale } }: { params: { locale: string } }) {
  ...
  const packages = await getPackages('security');
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-dark-100 mb-4">
            {locale === 'en' ? 'Our Security Systems' : 'أنظمتنا الأمنية'}
          </h1>
          <p className="text-gray-600 mb-4 max-w-2xl mx-auto">
            {locale === 'en' 
              ? 'Integrated security solutions for surveillance and protection.' 
              : 'لتوريد وتركيب كاميرات المراقبة وأنظمة الأمان.'}
          </p>
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <div className="text-center mb-8 border-b border-gray-100 pb-8">
                  <span className="text-gray-500 text-sm font-bold block mb-2">
                    {locale === 'en' ? (pkg.priceText_en || 'Price') : (pkg.priceText_ar || 'بسعر')}
                  </span>
                ...
                <div className="mb-8">
                  <h4 className="text-center font-bold text-dark-200 bg-gray-50 py-2 rounded-lg mb-6 border border-gray-100">
                    {locale === 'en' ? 'System Includes' : 'السيستم يشمل'}
                  </h4>
                ...
                <div className="mt-8">
                  ...
                  >
                    {locale === 'en' ? 'Contact Us for Details' : 'تواصل معنا لمعرفة التفاصيل'}
                  </Link>
                </div>
